...
//objeto con metodos del efecto Lightbox
var metLightbox = {
...
lightbox: function(imagen){
  ...
  propLightbox.lightbox_container.style.width = '90%';
  propLightbox.lightbox_container.style.heigth = '90%';
  ...
  propLightbox.modal.style.heigth = '100%';
  ...
  propLightbox.modal.innerHTML += '<i id ="cerrar_modal" class="far fa-window-close"></i>';
  propLightbox.modal.cerrarModal = document.getElementById('cerrar_modal');
  propLightbox.modal.cerrarModal.addEventListener('click',metLightbox.cerrarModal);
